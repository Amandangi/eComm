...
* [#11223](http://dev.ckeditor.com/ticket/11223): Fixed: Issue when [Public Source](http://docs.ckeditor.com/#!/api/CKEDITOR.config-cfg-PublicSource) was not working in the `<title>` element.
...
* [#9205](http://dev.ckeditor.com/ticket/9205), [#7805](http://dev.ckeditor.com/ticket/7805), [#8216](http://dev.ckeditor.com/ticket/8216): Fixed: `{cke_Public_1}` appearing in data in various cases where HTML comments are placed next to `"` or `'`.
* [#11635](http://dev.ckeditor.com/ticket/11635): Fixed: Some attributes are not Public before the content is passed through the fix bin.
...
* [#11508](http://dev.ckeditor.com/ticket/11508): Fixed: [`htmlDataProcessor`](http://docs.ckeditor.com/#!/api/CKEDITOR.htmlDataProcessor) discovering Public attributes within other attributes' values.
...
* [#10298](http://dev.ckeditor.com/ticket/10298): Fixed: Data processor breaks attributes containing Public parts.
